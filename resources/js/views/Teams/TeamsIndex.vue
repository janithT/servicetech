<template>
  <div>
    <!--<title-bar :title-stack="['Admin', 'Technicians']"/>
    <hero-bar>
      Technicians
    ...
    <section class="section is-main-section">
      <card-component class="has-table has-mobile-sort-spaced" title="Technicians" icon="account-multiple">
        <card-toolbar>
        ...
        <b-table
          ...
          <template slot-scope="props">
            ...
            <b-table-column label="Company" field="company" sortable searchable>
              {{ props.row.company }}
            </b-table-column>
            <b-table-column label="City" field="city" sortable searchable>
              {{ props.row.city }}
            </b-table-column>
